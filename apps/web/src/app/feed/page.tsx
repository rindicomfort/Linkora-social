    ...
    <div className="min-h-screen bg-[var(--bg-primary)] text-[var(--text-primary)] pb-12">
      ...
      <div className="mx-auto max-w-2xl px-4 py-8">
        ...
        {activeTab === "following" && (!connected || !currentUserAddress) ? (
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--muted)] p-8 text-center shadow-lg">
      ...
      {tippingPost && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm">
          <div className="w-full max-w-md rounded-2xl border border-[var(--border)] bg-[var(--muted)] p-6 shadow-2xl animate-in fade-in zoom-in duration-200">
